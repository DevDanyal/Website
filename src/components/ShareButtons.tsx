      ...
      <div className="flex gap-2">
        {shareLinks.map((link) => (
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className={`w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center text-[--text-secondary] transition-all ${link.color}`}
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.95 }}
          className="w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center text-[--text-secondary] hover:bg-[#2563EB]/20 hover:border-[#2563EB]/50 transition-all relative"
        ...
        >
          ...
          {copied && (
            <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#2563EB] text-white text-xs px-2 py-1 rounded whitespace-nowrap">
              Copied!
            </span>
          )}
        </motion.button>
